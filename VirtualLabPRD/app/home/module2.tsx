...
export default function Module1() {
  ...
  const originalUrl = 'https://drive.google.com/file/d/1eKG3j4i9Fy1Ly3IVB5Bm423O-kiTz_j4/view?usp=sharing';
  ...
  const downloadPDF = async () => {
    try {
      ...
      const downloadResumable = FileSystem.createDownloadResumable(
        pdfUrl,
        FileSystem.documentDirectory + 'Module2.pdf',
        {},
        (downloadProgress) => {
  ...
  return (
    <View style={styles.container}>
      <Stack.Screen options={{
        headerTitle: "Professional Engineering Ethics",
        headerStyle: {
